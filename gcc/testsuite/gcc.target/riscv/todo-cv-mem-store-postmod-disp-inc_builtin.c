...
void store_postmod_disp_inc(void)
{
  ...
  /* { dg-final { scan-assembler-times "cv\.sb .\\d+, 2047\\(.\\d+!\\)" 2 { xfail { riscv32-corev-elf && { any-opts "-O0" } } } } } */
  /* { dg-final { scan-assembler-times "cv\.sh .\\d+, 2047\\(.\\d+!\\)" 2 { xfail { riscv32-corev-elf && { any-opts "-O0" } } } } } */
  /* { dg-final { scan-assembler-times "cv\.sw .\\d+, 2047\\(.\\d+!\\)" 2 { xfail { riscv32-corev-elf && { any-opts "-O0" } } } } } */
