...
/* { dg-options "-march=rv32i_xcorevmem1p0 --save-temps -fno-tree-forwprop" } */
/* { dg-timeout 10 } */
...
void load_postdec(void)
{
  ...
  /* { dg-final { scan-assembler-times "cv\.lb .\\d+, -1\\(.\\d+!\\)" 1 { xfail { riscv32-corev-elf && { any-opts "-O0" } } } } } */
  /* { dg-final { scan-assembler-times "cv\.lbu .\\d+, -1\\(.\\d+!\\)" 1 { xfail { riscv32-corev-elf && { any-opts "-O0" } } } } } */
  /* { dg-final { scan-assembler-times "cv\.lh .\\d+, -2\\(.\\d+!\\)" 1 { xfail { riscv32-corev-elf && { any-opts "-O0" } } } } } */
  /* { dg-final { scan-assembler-times "cv\.lhu .\\d+, -2\\(.\\d+!\\)" 1 { xfail { riscv32-corev-elf && { any-opts "-O0" } } } } } */
  /* { dg-final { scan-assembler-times "cv\.lw .\\d+, -4\\(.\\d+!\\)" 2 { xfail { riscv32-corev-elf && { any-opts "-O0" } } } } } */
