...
void store_postmod_reg(void)
{
  /* { dg-final { scan-assembler-times "cv\.s" 6 { xfail { riscv32-corev-elf && { any-opts "-O0" } } } } } */
  /* { dg-final { scan-assembler-times "cv\.sb .\\d+, .\\d+\\(.\\d+!\\)" 2 { xfail { riscv32-corev-elf && { any-opts "-O0" } } } } } */
  /* { dg-final { scan-assembler-times "cv\.sh .\\d+, .\\d+\\(.\\d+!\\)" 2 { xfail { riscv32-corev-elf && { any-opts "-O0" } } } } } */
  /* { dg-final { scan-assembler-times "cv\.sw .\\d+, .\\d+\\(.\\d+!\\)" 2 { xfail { riscv32-corev-elf && { any-opts "-O0" } } } } } */
