...
/* { dg-options "-march=rv32im_xcorevmem1p0 --save-temps" } */
...
void load_postmod_disp_dec(void)
{
  ...
  /* { dg-final { scan-assembler-times "cv\.lb .\\d+, -2048\\(.\\d+!\\)" 1 { xfail { riscv32-corev-elf && { any-opts "-O0" } } } } } */
  /* { dg-final { scan-assembler-times "cv\.lbu .\\d+, -2048\\(.\\d+!\\)" 1 { xfail { riscv32-corev-elf && { any-opts "-O0" } } } } } */
  /* { dg-final { scan-assembler-times "cv\.lh .\\d+, -2048\\(.\\d+!\\)" 1 { xfail { riscv32-corev-elf && { any-opts "-O0" } } } } } */
  /* { dg-final { scan-assembler-times "cv\.lhu .\\d+, -2048\\(.\\d+!\\)" 1 { xfail { riscv32-corev-elf && { any-opts "-O0" } } } } } */
  /* { dg-final { scan-assembler-times "cv\.lw .\\d+, -2048\\(.\\d+!\\)" 2 { xfail { riscv32-corev-elf && { any-opts "-O0" } } } } } */
